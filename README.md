...
del titular, **añade una fila pendiente** en `_Comunidades` (columna B vacía) y
avisa en la interfaz: _«Comunidad no mapeada: …»_. Completa la columna B con la
pestaña correcta y reprocesa (marcando «Forzar reproceso»).
